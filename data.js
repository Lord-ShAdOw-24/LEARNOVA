...
const founders = [
  { id:1, name:"Founder Name 1", role:"Co-Founder & Chief Executive Officer", initials:"F1", photo:"ceo.jpg", bio:"Leads Learnova's vision and partnerships with schools and education authorities across Cameroon." },
  { id:2, name:"Founder Name 2", role:"Co-Founder & Chief Technology Officer", initials:"F2", photo:"cofounder-2.jpg", bio:"Oversees the engineering behind the app, the anti-piracy system and the L-Ai assistant." },
  { id:3, name:"Founder Name 3", role:"Co-Founder & Head of Academics", initials:"F3", photo:"cofounder-3.jpg", bio:"Coordinates the pedagogical team, the past-paper library and quiz calibration." },
  { id:4, name:"Founder Name 4", role:"Co-Founder & Head of Growth", initials:"F4", photo:"cofounder-4.jpg", bio:"Builds partnerships with schools, sponsors and the teacher community nationwide." }
];
